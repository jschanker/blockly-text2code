...
T2C.MSG.EN["TERMINAL_CONFIRM"] = "confirm";
T2C.MSG.EN["TERMINAL_AND"] = "&&";
T2C.MSG.EN["TERMINAL_OR"] = "||";
T2C.MSG.EN["TERMINAL_NOT"] = "!";
...
T2C.MSG.EN["TYPEIN_WARNING_UNNECESSARY_OPEN_PARENTHESIS"] = "Although you *can* have an (extra) opening parenthesis here, it's not necessary in this instance.  When you first start programming, it may be good to include additional ones to make sure operations are performed in the required order, but it can also make your code more difficult to read and correctly match the open parentheses with closing ones.  Before continuing, remove the extra opening parenthesis here since you don't need it.";
