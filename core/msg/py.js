...
T2C.MSG.PY["TERMINAL_AND"] = " and ";
T2C.MSG.PY["TERMINAL_OR"] = " or ";
T2C.MSG.PY["TERMINAL_NOT"] = "not ";
T2C.MSG.PY["TERMINAL_CONFIRM"] = "input"; // Python has no built-in confirm, any non-empty string is truthy value
